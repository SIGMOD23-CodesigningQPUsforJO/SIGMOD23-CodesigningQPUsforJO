...
def parse_QPU_data():
    ...
    for iterations in iterations_categories:
        for i in range(4):
            ...
            best_join_order, best_join_order_costs, valid_ratio, optimal_ratio = Postprocessing.postprocess_IBMQ_response(response, card, pred, pred_sel, thres_vals[i], optimal_join_order_costs = 0)
